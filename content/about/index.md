---
date: '2025-12-28T19:34:39-05:00'
draft: false
title: 'About'
...
- **LLM Reasoning & Hallucination Mitigation** — Structured frameworks (knowledge graphs, action grounding) that keep LLM agents honest and auditable
- **Stochastic Optimization** — Decision-making under uncertainty for fleet sizing, routing, and resource allocation
- **Autonomous Systems** — Multi-agent simulation, dispatching, and operational planning for delivery robots and EVs
...
1. **Reviewing the Reviewer: Graph-Enhanced LLMs for E-commerce Appeal Adjudication**
   Du, Li, Huang — arXiv preprint, 2026 · [arXiv](https://arxiv.org/abs/2603.19267) · [Details](/papers/amazon-rj/)

2. **Two-stage stochastic fleet and battery sizing with routing optimization for sidewalk delivery robots**
   Du, Yang, Chow, Le — Transportation Research Part E, 2025 · [DOI](https://doi.org/10.1016/j.tre.2025.104220) · [Details](/papers/sdr-two-stage/)

3. **Analytical model for large-scale design of sidewalk delivery robot systems with bounded makespans**
   Yang, Du, Le, Chow — Transportation Research Part C, 2025 · [DOI](https://doi.org/10.1016/j.trc.2024.104978)

4. **Understanding Social Perceptions of Sidewalk Delivery Robots Using Sentiment Analysis**
   Du, Le — Transportation Research Record, 2025 · [DOI](https://doi.org/10.2139/ssrn.4873047) · [Details](/papers/youtube-sc/)
